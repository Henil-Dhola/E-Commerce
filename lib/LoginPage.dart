...
import 'package:ecommerceassingment/SignupPage.dart';
  ...
  Widget _buildTop() {
    return SizedBox(
      ...
      child:  Column(
        ...
        children: [
          Image.asset("assets/image/profile.png",height: 90),
          Text(
            "E-Commerce",
            style: TextStyle(
                color: Colors.white,
        ...
        AuthenticationHelper()
          ...
          if (result == null) {
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => HomePage())).then((value) => Navigator.pop(context));
          } else {
